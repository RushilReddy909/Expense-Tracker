        ...
        <div className='register'>
          ...
          >
            <Form layout='vertical' onFinish={submitHandler} className='p-3'>
              <h1>Registration </h1>
              <Form.Item label="Username" name="name" rules={[{required: true, message: "Enter your Username"}]}>
                <Space.Compact block>
              ...
              <FormItem className='mt-3'>
                <Flex justify='center'>
                  <Button type='primary' htmlType='submit' block style={{fontWeight: "bold"}}>Register</Button>
                </Flex>
              </FormItem>
              <Flex justify='center'>
